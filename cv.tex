...
\cvitem{\textbf{15+ years of software development using C++\\}}{using last C++17 standard at work, \httplink[\bfseries{my C++ samples of code}]{github.com/alsam/cpp-samples}}
...
\cventry{May '18 -- Present}{Senior Software Engineer}
  {{\bfseries{NAUTO}}\  \httplink[http://www.nauto.com]{www.nauto.com}}{Krakow -- Palo-Alto}{Nauto is building a data platform for autonomous mobility that makes driving safer and fleets smarter} {
...
\cventry{September '16 -- August '17}{Software Engineer for Embedded Linux Solutions on NVIDIA Jetson TX1 for Ultra-Precise 3D Scanners}
  ...
  for more details see the blog \link[\slshape{NVIDIA Jetson Enables Artec 3D, Live Planet to Create VR Content in Real Time}]{https://blogs.nvidia.com/blog/2017/03/07/artec-liveplanet-jetson-vr-content} \bfseries{the development was conducted under Arch Linux using modern C++-14}.
}
