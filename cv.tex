...
\cvitem{proficiency in {\textbf{HPC - High Performance Computing}}}{{\textbf{cuSparse}}, {\textbf{cuBlas}}, {\textbf{cuSolver}}, {\textbf{Algebraic Multigrid (AMG)}}, \httplink[{\textbf{AMGCL}}]{github.com/ddemidov/amgcl}, \httplink[{\textbf{ROCM}}]{rocmdocs.amd.com/en/latest/}}
...
\cventry{September '19 -- Present}{Senior Software Developer}
    {{\bfseries{Huawei Corp.}}\ \httplink[http://www.huawei.com]{www.huawei.com} via Luxoft/DXC \httplink[http://www.dxc.com]{www.dxc.com}}{Moscow}{}{
        3D Graphics performance tools based on \httplink[{\textbf{RenderDoc}}]{github.com/baldurk/renderdoc} and other internal tools especially for Kirin and ARM Mali GPU. Mobile Programming for Huawei phones
}
