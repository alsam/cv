...
\cvitem{\textbf{15+ years of software development using C++\\}}{using last C++17 standard at work, \httplink[my C++ samples of code]{https://github.com/alsam/cpp-samples}}
...
\cvitem{proficiency in {\textbf{HPC - High Performance Computing}}}{{\textbf{cuSparse}}, {\textbf{cuBlas}}, {\textbf{cuSolver}}, {\textbf{Algebraic Multigrid (AMG)}}, \httplink[{\textbf{AMGCL}}]{https://github.com/ddemidov/amgcl}}
...
\cventry{September '19 -- Present}{Senior Software Developer}
    {{\bfseries{Huawei Corp.}}\ \httplink[http://www.huawei.com]{www.huawei.com} via Luxoft/DXC \httplink[http://www.dxc.com]{www.dxc.com}}{Moscow}{}{
        3D Graphics performance rools based on \httplink[{\textbf{RenderDoc}}]{https://github.com/baldurk/renderdoc} and other internal tools especially for Kirin and ARM Mali GPU. Mobile Programming for Huawei phones
}

\cventry{October '18 -- August '19}{Senior Software Engineer}
  {{\bfseries{Align Technology}}\  \httplink[http://www.aligntech.com/]{http://www.aligntech.com/}}{Moscow -- Rayleigh North Carolina}{} {
...
\cventry{August '17 -- April '18}{Lead Software Developer}
  {{\bfseries{Abagy Robotic Systems}}\  \httplink[http://www.abagy.com]{http://www.abagy.com}}{Moscow}{} {
  ...
  \httplink[{\bfseries{CGAL}}]{http://www.cgal.org}; design and implementation of the robot transport protocol, the simulator for the protocol has been written using \httplink[\bfseries{ROS-Industrial core}]{https://github.com/ros-industrial/industrial_core} and \httplink[\bfseries{Boost.Asio}]{https://www.boost.org/doc/libs/1_65_1/doc/html/boost_asio.html}
}
...
\cventry{September '16 -- August '17}{Software Engineer for Embedded Linux Solutions on NVIDIA Jetson TX1 for Ultra-Precise 3D Scanners}
    {{\bfseries{Artec 3D}}\  \httplink[https://www.artec3d.com]{http://www.artec3d.com}}{Moscow}{handheld 3D scanners} {
  ...
  for more details see the blog \httplink[\slshape{NVIDIA Jetson Enables Artec 3D, Live Planet to Create VR Content in Real Time}]{https://blogs.nvidia.com/blog/2017/03/07/artec-liveplanet-jetson-vr-content} \bfseries{the development was conducted under Arch Linux using modern C++-14}.
}

\cventry{June '15 -- August '16}{Software Development Engineer; Sr.Software Development Engineer from September '15}
    {{\bfseries{Mentor Graphics}}\ \httplink[www.mentor.com]{https://www.mentor.com}}{Moscow}{}{
  Sr.Software Development Engineer for 
  \httplink[{\bfseries{Calibre Computational Lithography}}]{https://www.mentor.com/products/ic-manufacturing/computational-lithography}
...
\cventry{December '14 -- June '15}{Principal Engineer for Advanced Projects}
    {{\bfseries{Huawei Corp.}}\ \httplink[http://www.huawei.com]{http://www.huawei.com}}{Moscow}{}{
  projects for Domain-Specific Languages for GPU programming based on: \\
  \emph{Delite} - \httplink[stanford-ppl.github.io/Delite]{https://stanford-ppl.github.io/Delite} \\
...
\cventry{July 2010 -- December '14\\ 4.5 years}{Performance Architect}
    {{\bfseries{NVidia}}\ \httplink[www.nvidia.com]{https://www.nvidia.com}}{Moscow}{}{
...
\cventry{April 2007 -- June 2010 \\ 3 years, 3 months}{Sr.Software Engineer}
    {{\bfseries{Cadence Design Systems}}\ \httplink[www.cadence.com]{https://www.cadence.com}}{Moscow}{}{
...
\cventry{August 2003 -- March 2007 \\ 3.5 years}{Sr.CAD Engineer}
    {{\bfseries{Intel Corp.}}\ \httplink[http://www.intel.com]{https://www.intel.com}}{Moscow}{}{
